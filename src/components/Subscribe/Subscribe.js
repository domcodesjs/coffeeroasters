    ...
    <StyledDiv className='wrapper'>
      ...
      <section className='steps'>
        ...
        <div className='steps__item'>
          ...
          <p>
            ...
            enjoy award-winning world-className coffees curated to provide a
      ...
      <section className='preferences'>
        <div className='preferences__option'>
          ...
          <div className='preferences__option__choices'>
            <div className='preferences__option__choices__item'>
              <h3>Capsule</h3>
        ...
        <button className='preferences__btn'>Create my plan!</button>
      </section>
    </StyledDiv>
  );
};
